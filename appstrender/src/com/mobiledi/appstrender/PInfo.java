	...
	public ArrayList<AppObject> getInstalledComponentList(int MODE)
		...
		for (ResolveInfo ri : ril) {
			if (ri.activityInfo != null) {
				...
				if(recieved<0){recieved=0;send=0;}
				
				//String info=con.getPackageManager().getApplicationInfo(ri.activityInfo.applicationInfo);
...
Log.d("New Pack Info", tempObj.getAppUid()+" " + tempObj.getAppName());
