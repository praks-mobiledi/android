...
public class PackageInformationTotal {
	...
	private String individual_mb;
	private double totalData;
	public PackageInformationTotal(Context con_){
		this.con=con_;
	...
	public void getPakagesInfoUsingHashMap() {
	    ...
	    for (ApplicationInfo packageInfo : packages) {
	        ...
	        if(total>0)
	        {
	            PackageInformationTotal pi=new PackageInformationTotal(con);
	            pi.name=name;
